...
from axiomata.master_theorem import critical_exponent, calculate
...
def test_explain_true_prints_regularity_for_case_3(capsys):
    calculate(3, 4, "n*log(n)", explain=True)
    out = capsys.readouterr().out
